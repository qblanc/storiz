...
ActiveRecord::Schema.define(version: 2019_11_29_120941) do
  ...
  create_table "character_events", force: :cascade do |t|
    ...
    t.index ["scene_id"], name: "index_character_events_on_scene_id"
  end
  ...
  add_foreign_key "character_events", "scenes"
