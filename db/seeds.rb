...
character9 = Character.new(first_name: "Inspector", last_name: "Holdaway", birthdate: "Fri, 12 Nov 1948 16:55:29 UTC +00:00", genre: "Male", description: "He is a cop, who teaches Freddy Newendyke aka Mr. Orange how to go undercover and infiltrate Joe Cabot's organization.")
...
character10 = Character.new(first_name: "Mr.", last_name: "Blue", birthdate: "Mon, 04 May 1942 16:55:29 UTC +00:00", genre: "Male", description: "He is one of the six robbers in a diamond heist that goes wrong. He smokes cigars, and his death is unknown until the end of the film, where Joe Cabot says that he was killed by the cops.")
...
scene5 = Scene.new(title: "The Run Away", number: 5, content: "Scene 5")
scene5.project = project1
scene5.save!

scene6 = Scene.new(title: "Bathroom Talks", number: 6, content: "Scene 6")
scene6.project = project1
scene6.save!

scene7 = Scene.new(title: "Mr. White Story", number: 7, content: "Scene 7")
scene7.project = project1
scene7.save!

scene8 = Scene.new(title: "Don't Say The Name", number: 8, content: "Scene 8")
scene8.project = project1
scene8.save!

scene9 = Scene.new(title: "A Rat In The House", number: 9, content: "Scene 9")
scene9.project = project1
scene9.save!

scene10 = Scene.new(title: "The Outside", number: 10, content: "Scene 10")
scene10.project = project1
scene10.save!
